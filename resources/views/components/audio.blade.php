{{-- <div class="flex items-center space-x-2 rtl:space-x-reverse">
    ...
    <svg aria-hidden="true" class="w-[145px] md:w-[185px] md:h-[40px]" viewBox="0 0 185 40" fill="none"
    ...
    <span
        class="inline-flex self-center items-center p-2 text-sm font-medium text-gray-900 dark:text-white">3:42</span>
</div> --}}
<div class="flex items-center space-x-2 rtl:space-x-reverse">

      <audio id="song" class=" w-full max-w-md mx-auto" controls>
