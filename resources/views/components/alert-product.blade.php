@if(request($text))
<div class="flex w-max items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
    <span class="sr-only">Info</span>
    <div class="ms-3 text-sm font-medium">
     {{$titleLabel}} : 
     <div class="flex items-center">
      <div class=""><img class="rounded-full h-10" src="{{$product->image ?? asset("assets/images/logo.png")}}" alt="" srcset=""></div>
