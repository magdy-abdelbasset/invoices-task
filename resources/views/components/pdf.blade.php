<div class="flex items-start justify-between my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2">
    <div class="me-2">
       ...
       <span class="flex text-xs font-normal text-gray-500 dark:text-gray-400 gap-2">
          {{getPDFPages($file)}} Pages 
          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="self-center" width="3" height="4" viewBox="0 0 3 4" fill="none">
             <circle cx="1.5" cy="2" r="1.5" fill="#6B7280"/>
          </svg>
          {{fileSize_($file) * 10**-6}} MB 
          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="self-center" width="3" height="4" viewBox="0 0 3 4" fill="none">
             <circle cx="1.5" cy="2" r="1.5" fill="#6B7280"/>
          </svg>
          PDF
    ...
    <a class="inline-flex self-center items-center" href="{{$file}}"
    download="download">
